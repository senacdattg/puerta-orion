                    ...
                    <div class="content-panel">
                        <div class="panel-header">
                            ...
                            <div class="panel-actions">
                                <button class="btn btn--small btn--outline" @click="mostrarFiltros = !mostrarFiltros">
                                    <i class="fas fa-filter"></i>
                                    Filtros
                                </button>
                                <button class="btn btn--small btn--outline" @click="mostrarBusqueda = !mostrarBusqueda">
...
.btn--primary:hover {
    ...
    box-shadow: 0 4px 15px rgba(247, 214, 0, 0.4);
}
