...
class Diagnostico(BaseModel):
    ...
    tipo_enfermedad = db.relationship('TipoEnfermedad', lazy=True, overlaps="diagnosticos")

    # Relación con DiagnosticoDeportista (uno a muchos)
    diagnosticos_deportista = db.relationship('DiagnosticoDeportista', lazy=True, overlaps="diagnostico")
